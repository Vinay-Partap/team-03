...
import { User, Mail, Lock, Eye, EyeOff, UserCheck, ArrowRight } from "lucide-react";
...
export default function Register() {
  ...
  return <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md bg-[#0b1329]/50 backdrop-blur-xl border border-white/10 rounded-3xl p-6 sm:p-8 shadow-[0_0_50px_rgba(59,130,246,0.08)]">
    ...
    <p className="mt-4 text-center text-sm text-slate-400">Already have an account? <Link to="/login" className="font-semibold text-blue-400">Sign in <ArrowRight className="inline h-4 w-4" /></Link></p>
  </motion.div>;
}
